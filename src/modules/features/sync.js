 ...
 */
export async function withSyncLock(syncFunction, ...args) {
 ...
 */
export function initializeSimpleSync() {
 ...
 */
export function cleanupSyncEventListeners() {
 ...
 */
export async function uploadAllTasks() {
 ...
 */
export async function downloadAllTasks() {
 ...
 */
export async function smartDownloadTasks() {
 ...
 */
export async function downloadTasksFromCloud() {
    return downloadAllTasks();
}
 ...
 */
export async function pullLatestFromCloud(force = false) {
 ...
 */
export async function mergeTasksWithConflictResolution(serverTasks) {
 ...
 */
export async function uploadAllLists() {
 ...
 */
export async function performComprehensiveSync() {
 ...
 */
export async function uploadAllTemplates() {
 ...
 * Uses sync lock to prevent race conditions
 */
export async function performStaleBrowserRecovery() {
    return withSyncLock(async () => {
 ...
 */
export function ensureSyncInitialized() {
