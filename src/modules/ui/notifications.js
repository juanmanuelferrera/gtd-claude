...
// Active toasts tracking (module state)
let activeToasts = [];
 ...
 * @returns {HTMLElement} Toast element
 */
export function showWarningToast(message, title, options = {}) {
    return showToast({
        type: 'warning',
        title,
        message,
 ...
 * @returns {HTMLElement} Toast element
 */
export function showInfoToast(message, title, options = {}) {
    return showToast({
        type: 'info',
        title,
        message,
 ...
 * @returns {HTMLElement|null} Toast container or null if not initialized
 */
