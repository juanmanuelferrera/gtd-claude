...
// Import dependencies
import { escapeHtml, formatDate, getLocalDateString } from '../core/utils.js';
// Template filter functions for Week and Month views
export function renderWeekTemplateFilters(weekTasks) {
...
export function renderMonthTemplateFilters(monthTasks) {
...
export function filterWeekByTemplate(template) {
...
export function clearWeekTemplateFilter() {
...
export function filterMonthByTemplate(template) {
...
export function clearMonthTemplateFilter() {
...
export function openIOSDateTimePicker(taskId, currentDate, currentTime, buttonElement) {
...
export function selectInlineCalendarDate(taskId, day) {
...
export function changeCalendarMonth(taskId, direction) {
...
export function refreshInlineCalendar(taskId) {
...
export function setCalendarToday(taskId) {
    const today = new Date();
...
export function setCalendarQuickDate(taskId, daysFromToday) {
    const date = new Date();
...
// Set quick date
export function setQuickDate(daysFromToday) {
    const date = new Date();
    date.setDate(date.getDate() + daysFromToday);
...
export function initUnifiedDateTimeModal(currentDate, currentTime) {
    // Reset selections
...
export function openTimeDropdown(taskId, currentTime, buttonElement) {
    // Remove any existing picker
...
export function closeTimeDropdown() {
...
export function setTimeAndClose(taskId, time) {
    updateTaskTime(taskId, time, { stopPropagation: () => {} });
    closeTimeDropdown();
}

export function clearTimeAndClose(taskId) {
    updateTaskTime(taskId, '', { stopPropagation: () => {} });
    closeTimeDropdown();
}

// Quick time selection
export function setTimeQuick(taskId, timeType) {
    let time = '';
    switch(timeType) {
        case 'morning':
            time = '09:00';
...
export function renderTemplateButtonsSection() {
...
export function toggleTimeBlock(timeKey) {
    if (!timeKey) return;
...
export function selectAndSetCalendarDay(day) {
...
export function clearTaskModalTimeout() {
...
export function setTaskModalTimeout() {
...
export function openAddTaskModalMobile(dateStr) {
...
export function provideFeedback(element, type = 'success') {
    if (!element) return;
...
export function autoExpandSectionsWithResults(filteredTasks) {
    try {
...
export function performMobileSearch(value) {
...
export function searchCurrentViewTasks(searchTerm, selector) {
...
export function performAllTasksSearch() {
...
export function clearAllTasksTemplateFilter() {
...
export function searchMonthTasks() {
...
export function searchWeekTasks() {
...
export function searchRepeatTasks() {
...
export function delaySelectedTasks(days) {
    // Use the selectedTaskIds variable from ui.js for consistency
    const selectedTasksSet = window.selectedTaskIds || selectedTasks || new Set();
...
export function showImportOptionsModal() {
...
export function refreshUndoView() {
...
export function checkAllBackups() {
    // Check backup status
...
// Modal functions
export function openDateTimeModal() {
...
export function initializeDateTimePickers(dateStr, timeStr) {
...
export function populateDayPicker(month, year) {
    const dayPicker = document.getElementById('desktopDayPicker');
    if (!dayPicker) return;
...
export function updateDesktopDateTime() {
...
export function closeDateTimeModal(event) {
...
export function applyDesktopDateTime() {
...
export function applyMobileDateTime() {
...
export function openBulkTimeModal() {
...
export function closeBulkTimeModal() {
...
export function handleJsonImportFile(event) {
    const file = event.target.files[0];
    if (!file) return;
...
export function handleTextImportFile(event) {
    const file = event.target.files[0];
    if (!file) return;
...
export function resetTaskTitle() {
...
export function saveAutoPrintTime() {
...
export function updateSyncPeriod() {
...
export function applyKeyboardOnlyMode(keyboardOnlyMode) {
...
export function applyTabDisplayMode(mode) {
...
export function applyMobileUIVersion(version) {
...
export function toggleKeyboardOnlyMode() {
...
export function openCreateListModal(sectionId) {
...
export function openListModal(sectionId, listId) {
...
export function insertTemplateToTask(template) {
...
// Open Add Task Modal
export function openAddTaskModal(dateStr) {
...
export function populateDateTimeModal(currentDate, currentTime) {
...
export function selectModalDate(dateStr) {
    window.selectedModalDate = dateStr;
    updateDateTimeDisplay();
...
export function filterTodayByTemplate(template) {
...
export function clearTodayTemplateFilter() {
    window.activeTodayTemplateFilter = null;
    renderTodayView();
}

// Time slot drag and drop for Today view
export function handleTimeSlotDragOver(e) {
    e.preventDefault();
    e.dataTransfer.dropEffect = 'move';
}

export function handleTimeSlotDragEnter(e) {
    e.preventDefault();
    if (window.draggedTask) {
        e.currentTarget.classList.add('drop-target');
    }
...
export function handleTimeSlotDragLeave(e) {
...
export function toggleAllListSections(sections) {
...
export function toggleAllTimeBlocks(timeBlocks) {
...
export function showListSelectionForTXTImport() {
...
export function quickBackupJSON() {
    try {
        const backup = {
            version: '1.0',
...
export function importJSONBackup(input) {
...
export function toggleAllTimeSlots() {
...
// Export functions
export function downloadTodayHtml() {
    const today = new Date();
...
export function exportRepeatHtml() {
...
export function renderRecentActionsView() {
 ...
 */
export function restoreAllTasksUI() {
 ...
 */
export function restoreDeletedTask(taskId) {
    const task = tasks.find(t => t.id === taskId);
    if (!task) {
...
export function restoreAllDeletedTasks() {
    const deletedTasks = tasks.filter(task => task.status === 'deleted');
...
export function deleteAllDeletedTasks() {
    const deletedTasks = tasks.filter(task => task.status === 'deleted');
...
export function undoSpecificAction(stackIndex) {
...
export function setupCollapseExpandKeyboardSupport() {
...
export function searchRecentActions() {
...
export function renderFilteredActions(actions, searchTerm = '') {
    const tasksView = document.getElementById('tasks-view');
    if (!tasksView) return;
...
export function refreshRecentActionsView() {
    renderRecentActionsView();
}
...
export function searchUndoHistory() {
...
export function initCalendarModal(currentDate, currentTime) {
...
export function highlightSelectedTime() {
...
export function applyCalendarDateTime() {
...
export function toggleMobileTimeDropdown(taskId, event) {
...
export function showSwipeToTomorrowFeedback(taskElement, taskId) {
...
export function moveAllTasksToCurrentTime() {
...
export function handleAllTasksMobileTemplateFilter(selectedValue) {
    if (selectedValue === '') {
...
export function handleMobileTemplateFilter(selectedValue) {
...
export function closeListItemsModal(event) {
    if (event && event.target !== event.currentTarget) return;
...
export function handleAddItemKeyPress(event) {
    if (event.key === 'Enter') {
 ...
 */
export function initiateDeleteAllData() {
...
export function cancelDeleteAllData() {
...
export function executeDeleteAllData() {
